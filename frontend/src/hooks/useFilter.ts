...
import { Dispatch, useReducer, useState, useEffect } from "react";
...
export default function useFilter(options: UseFilterOptions) {
  ...
  const [deboucedFilterState] = useDebounce(filterState, options.debounceTime);
