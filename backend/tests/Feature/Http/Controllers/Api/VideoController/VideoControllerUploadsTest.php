...
class VideoControllerUploadsTest extends BaseVideoControllerTestCase{
    ...
    public function testInvalidationThumbField(){
        $this->assertInvalidationFile('thumb_file',
                                      'jpg',
                                      Video::THUMB_FILE_MAX_SIZE,'image');
    }

    public function testInvalidationBannerField(){

        $this->assertInvalidationFile('banner_file',
                                      'jpg',
                                      Video::BANNER_FILE_MAX_SIZE,'image');
    }

    public function testInvalidationVideoField(){

        $this->assertInvalidationFile('video_file', 
                                     'mp4',
    ...
    public function testInvalidationTrailerField(){
        ...
        $this->assertInvalidationFile('trailer_file',
                                      'mp4',
